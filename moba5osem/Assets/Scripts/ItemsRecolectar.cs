...
public class ItemsRecolectar : MonoBehaviour
{
    //--|||--|||--
    #region Propiedades Clase
    [SerializeField] private List<TextMesh> textoObjetivos;
    [SerializeField] private List<short> objetosObjetivosConseguidos;
    [SerializeField] private List<short> maximoObjetosConseguir;
    [SerializeField] private List<bool> objetivoCompletado;
    #endregion
    //--|||--|||--
